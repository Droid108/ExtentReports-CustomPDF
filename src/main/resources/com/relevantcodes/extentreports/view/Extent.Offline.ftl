...
<html>
	...
	<body class='extent default ${theme}'>
		<!-- nav -->
		<nav>
				...
				<div class='col' style="display:none;">
					<div class='contents'>
						...
						<div class='card-panel filters'>
							<div>
								<a id='refreshCharts' alt='Refresh Charts on Filters' title='Refresh Charts on Filters' class='enabled'><i class='fa fa-refresh icon'></i></i></a>
							</div>
						</div>
					</div>
				</div>

				<div id='test-details-wrapper' class='col _addedCell2' style="width:100%;">
					<div class='contents'>
						<div class='card-panel heading'>
                    		<h2>${resourceBundle.getString("tests.heading")}</h2>
                    	</div>
						<div class='card-panel details-view'>
							<div class='details-container'>
                                    ...
                                    <ul id='test-collection' class='test-collection'>
                                        <#list report.testList as extentTest>
                                            ...
                                            <li class='collection-item test displayed active ${test.status} <#if test.nodeList?size != 0>hasChildren</#if>' extentid='${test.id?string}'>
                                                <div class='test-head'>
                                                    <h5>${test.name} <#if test.internalWarning??><i class='tooltipped mdi-alert-error' data-position='top' data-delay='50' data-tooltip='${test.internalWarning}'></i></#if></h5>
                                ...
                                <div class='card-panel details-view'>
                                <div id='dashboard-view' class='row' style="display: block !important;background: #eceff5;padding: 5px;">
					...
					<div class='col l2 m4 s6'>
						<div class='card suite-total-tests'>
							...
							<span class='total-tests'> <span class='panel-lead'>${testsCount}</span> </span>
						</div>
					</div>
					<div class='col l2 m4 s6'>
						<div class='card suite-total-steps'>
							<span class='panel-name'>${resourceBundle.getString("dashboard.panel.name.totalSteps")}</span>
							<span class='total-steps'> <span class='panel-lead'>${stepsCount}</span> </span>
						</div>
					</div>
...
<script type='text/javascript' src='./extentreports/js/scripts.js'></script></script>
